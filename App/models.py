...
class PreBuilt(models.Model):
    ...
    modal_code = models.CharField(max_length=255, unique=True)
    modal_cpu = models.CharField(max_length=255)
    modal_monitor = models.CharField(max_length=255)
    modal_ram = models.CharField(max_length=255)
    modal_motherbrd = models.CharField(max_length=255)
    modal_gpu = models.CharField(max_length=255)
    modal_ssd = models.CharField(max_length=255)
    modal_storage_rom = models.CharField(max_length=255)
    modal_smps = models.CharField(max_length=255)
    modal_offer = models.CharField(max_length=255)
    date_added = models.DateField(auto_now_add=True)
    description = models.TextField(blank=True, null=True)
    price = models.CharField(max_length=20, null=True, blank=True, default="")
    status = models.BooleanField(default=True)
